...
val moduleBuild = ScalaBuild("com.logicovercode", "fluent-style-sbt", "0.0.525")
  ...
  .dependencies(
    ...
    "com.logicovercode" %% "fsbt-commons" % "0.0.002",
  )
  .sbtPlugins(
    "com.logicovercode" %% "fluent-style-sbt-core" % "0.0.425",
